...
| FR-04 | Sinh viên tìm kiếm học phần theo mã/tên học phần hoặc mã/tên/khoa của giảng viên; hỗ trợ chuỗi một phần, không phân biệt hoa thường và dấu tiếng Việt | `CourseService.search`, `courseApi.searchCourses`, `Header` |
