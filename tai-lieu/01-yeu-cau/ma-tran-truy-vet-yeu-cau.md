...
| FR-04 Course search | `GET /api/courses/search`, gợi ý tìm kiếm trong `Header` | `CourseServiceTest`, `CourseControllerTest`, `CourseApiIT` | Tìm `OOP`, `TS.`, tên giảng viên không dấu, mã giảng viên và chuỗi rỗng |
